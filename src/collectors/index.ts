import type { Collectables, Collectable, CollectableProxy, CollectableProxyCtr } from './interface';
...
export function collect<
  T,
  R extends Collectable<T> = Collectable<T>,
>(iterable: Iterable<T>, init: R): R;
 ...
 */
export function collect<K extends PropertyKey, V>(
  iterable: Iterable<Entry<K, V>>,
  init: Record<PropertyKey, any>,
): Record<K, V>;
 ...
 */
export function collect<K, V>(
  iterable: AsyncIterable<Entry<K, V>>,
  init: Map<K, V>,
): Promise<Map<K, V>>;
...
export function collect<
  T,
  R extends Collectable<T> = Collectable<T>,
>(iterable: AsyncIterable<T>, init: R): Promise<R>;
