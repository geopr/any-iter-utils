 ...
 */
export function flatMap<T, R>(iterable: Iterable<T>, cb: (val: T) => Iterable<R> | R): IterableIterator<R>;
 ...
 */
export function flatMap<T, R>(iterable: AsyncIterable<T>, cb: (val: T) => AnyIterable<R> | R): AsyncIterableIterator<R>;

/**
 * service overload
 */
export function flatMap<T, R>(iterable: AnyIterable<T>, cb: (val: T) => AnyIterable<R> | R): AnyIterableIterator<R>;
