 ...
 */
export function every<T>(iterable: Iterable<T>, predicate: (val: T) => boolean): boolean;
 ...
 */
export function every<T>(iterable: AsyncIterable<T>, predicate: (val: T) => boolean): Promise<boolean>;

/**
 * Service overload
 */
export function every<T>(iterable: AnyIterable<T>, predicate: (val: T) => boolean): Promisify<boolean>;

export function every<T>(iterable: AnyIterable<T>, predicate: (val: T) => boolean): Promisify<boolean> {
  return isAsyncIterable(iterable) ? aevery(iterable, predicate) : severy(iterable, predicate);
}

function severy<T>(iterable: Iterable<T>, predicate: (val: T) => boolean): boolean {
...
async function aevery<T>(iterable: AsyncIterable<T>, predicate: (val: T) => boolean): Promise<boolean> {
