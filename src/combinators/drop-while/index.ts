 ...
 */
export function dropWhile<T>(iterable: Iterable<T>, predicate: (val: T) => boolean): IterableIterator<T>;
 ...
 */
export function dropWhile<T>(iterable: AsyncIterable<T>, predicate: (val: T) => boolean): AsyncIterableIterator<T>;

/**
 * service overload
 */
export function dropWhile<T>(iterable: AnyIterable<T>, predicate: (val: T) => boolean): AnyIterableIterator<T>;
