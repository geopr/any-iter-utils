 ...
 */
export function drop<T>(iterable: Iterable<T>, amount: number): IterableIterator<T>;
 ...
 */
export function drop<T>(iterable: AsyncIterable<T>, amount: number): AsyncIterableIterator<T>;

/**
 * service overload
 */
export function drop<T>(iterable: AnyIterable<T>, amount: number): AnyIterableIterator<T>;
