 ...
 */
export function take<T>(iterable: AsyncIterable<T>, amount: number): AsyncIterableIterator<T>;

/**
 * service overload
 */
export function take<T>(iterable: AnyIterable<T>, amount: number): AnyIterableIterator<T>;
