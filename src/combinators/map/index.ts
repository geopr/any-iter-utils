 ...
 */
export function map<T, R>(iterable: Iterable<T>, cb: (value: T) => R): IterableIterator<R>;
 ...
 */
export function map<T, R>(iterable: AsyncIterable<T>, cb: (value: T) => R): AsyncIterableIterator<R>;

/**
 * service overload
 */
export function map<T, R>(iterable: AnyIterable<T>, cb: (value: T) => R): AnyIterableIterator<R>;
