...
function fold(iterable, init, cb) {
    return (0, utils_1.isAsyncIterable)(iterable) ? afold(iterable, init, cb) : sfold(iterable, init, cb);
}
exports.fold = fold;
function sfold(iterable, init, cb) {
    for (const value of iterable) {
        init = cb(init, value);
    }
    return init;
}
function afold(iterable, init, cb) {
