...
function forEach(iterable, cb) {
    return (0, utils_1.isAsyncIterable)(iterable) ? aforEach(iterable, cb) : sforEach(iterable, cb);
}
exports.forEach = forEach;
function sforEach(iterable, cb) {
    return new containers_1.SyncPromise((resolve) => {
...
function aforEach(iterable, cb) {
    return new containers_1.SyncPromise((resolve) => __awaiter(this, void 0, void 0, function* () {
        var _a, e_1, _b, _c;
        try {
