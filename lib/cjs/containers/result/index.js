...
exports.Err = exports.Ok = exports.Result = exports.ResultError = void 0;
const utils_1 = require("../../utils");
const containers_1 = require("../../containers");
const error_1 = require("./error");
Object.defineProperty(exports, "ResultError", { enumerable: true, get: function () { return error_1.ResultError; } });
/**
...
class Result {
    ...
    ok() {
        return this.match({
            Ok: (containers_1.Option.Some),
            Err: (containers_1.Option.None),
        });
    }
    /**
    ...
    err() {
        return this.match({
            Ok: (containers_1.Option.None),
            Err: (containers_1.Option.Some),
        });
    }
    and(val) {
        return this.match({
...
_Result_instances = new WeakSet(), _Result_unwrapF = function _Result_unwrapF(target) {
    return (val) => (0, utils_1.isFunction)(target) ? target(val) : target;
};
/**
