...
export class SyncPromise {
     ...
     */
        ...
        return new SyncPromise((resolve, reject) => {
            __classPrivateFieldGet(this, _SyncPromise_resolvers, "f").push(cast(resolve));
            __classPrivateFieldGet(this, _SyncPromise_rejecters, "f").push((err) => {
                try {
                    if (onReject == null) {
                        reject(err);
    ...
    unwrap() {
        ...
        assert(__classPrivateFieldGet(this, _SyncPromise_instances, "a", _SyncPromise_isFullfilled_get), 'cannot unwrap pending SyncPromise');
