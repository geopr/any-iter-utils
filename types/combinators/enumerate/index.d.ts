 ...
 */
export declare function enumerate<T>(iterable: Iterable<T>): IterableIterator<Entry<number, T>>;
/**
 ...
 */
export declare function enumerate<T>(iterable: AsyncIterable<T>): AsyncIterableIterator<Entry<number, T>>;
/**
 * service overload
 */
export declare function enumerate<T>(iterable: AnyIterable<T>): AnyIterableIterator<Entry<number, T>>;
