 ...
 */
export declare function filter<T>(iterable: AsyncIterable<T>, predicate: (value: T) => boolean): AsyncIterableIterator<T>;
/**
 * service overload
 */
export declare function filter<T>(iterable: AnyIterable<T>, predicate: (value: T) => boolean): AnyIterableIterator<T>;
