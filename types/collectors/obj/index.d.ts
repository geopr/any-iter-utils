 ...
 */
export declare function intoObj<K extends PropertyKey, V>(iterable: Iterable<Entry<K, V>>, init?: AnyObject): Record<K, V>;
/**
 ...
 */
export declare function intoObj<K extends PropertyKey, V>(iterable: AsyncIterable<Entry<K, V>>, init?: AnyObject): Promise<Record<K, V>>;
/**
 * service overload
 */
export declare function intoObj<K extends PropertyKey, V>(iterable: AnyIterable<Entry<K, V>>, init?: AnyObject): Promisify<Record<K, V>>;
